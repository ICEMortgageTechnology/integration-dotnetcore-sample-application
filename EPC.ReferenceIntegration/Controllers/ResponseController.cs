...
/// <summary>
/// This controller is for Create Response.
/// The create response can either happen from here or from the Check Status button on the screen
/// Note: This controller is not being used in the Reference Integration
/// </summary>
