...
{
    /// <summary>
    /// This class is to maintain an in-memory repository for the status of Transactions by TransactionId.
    /// It is basically a Dictionary which holds the status of the transaction. In real world scenarios this would come from a Database or some data store at the partner's end.
    /// </summary>
